...
pred_svm = predict(SVM_model,newdata=t2,na.action=na.pass)
#Find RMSE
...
summary_data <- data.frame(Model=c("OLS","PLS","elasticNet","SVM"),Method=c("lm","plsr","glmnet","svm"),Package=c("stats","pls","caret","e1071"),Hyperparameter=c("NA","ncomp",0,"cost, gamma, epsilon"),Value=c("NA",31,0,"1,0.03125,0.1"),CV_RMSE=c(OLS_RMSE,PLS_RMSE,ELASTIC_RMSE,SVM_RMSE),CV_R2=c(OLS_R2,PLS_R2,ELASTIC_R2,0))
