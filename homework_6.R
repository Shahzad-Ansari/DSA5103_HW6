...
testing = aggregate(revenue~.,training_data,sum)

temp = training_data[training_data$custId == 23479,]
...
counter = count(training_data$custId)


# ols

str(training_data$subContinent)
